  ...
  for await (const message of query({
    ...
    options: {
      ...
      mcpServers: {
        ...
        gemini: {
          command: 'npx',
          args: ['-y', '@google/model-context-protocol-server-google-ai-multimodal'],
          env: {
            GOOGLE_AI_API_KEY: sdkEnv.GOOGLE_AI_API_KEY || '',
            GOOGLE_AI_MODEL: sdkEnv.GOOGLE_AI_MODEL || 'gemini-flash-lite-latest',
          },
        },
      },
      hooks: {
